...
_Q1_P1 = [
    (OpUnit.SEQ_SCAN, [600000, 48, 7, 600000]),
...
_Q1_P3 = [(OpUnit.SORT_ITERATE, [4, 92, 10, 4]), (OpUnit.OUTPUT, [4, 92, 10, 0])]

_Q4_P1 = [
    (OpUnit.SEQ_SCAN, [150000, 24, 3, 100]),
    (OpUnit.OP_DECIMAL_COMPARE, [300000, 4, 1, 300000]),
    (OpUnit.HASHJOIN_BUILD, [5357, 4, 1, 5357]),
]

_Q4_P2 = [
    (OpUnit.SEQ_SCAN, [600000, 12, 3, 100]),
    (OpUnit.OP_INTEGER_COMPARE, [600000, 4, 1, 600000]),
...
_Q5_P5 = [
    (OpUnit.SEQ_SCAN, [1000, 8, 2, 1000]),
    (OpUnit.HASHJOIN_BUILD, [1000, 8, 2, 1000]),
]

_Q5_P6 = [
    (OpUnit.SEQ_SCAN, [600000, 24, 4, 600000]),
...
_Q7_P5 = [
    (OpUnit.SEQ_SCAN, [600000, 28, 5, 600000]),
    (OpUnit.OP_INTEGER_COMPARE, [1200000, 4, 1, 1200000]),
...
_Q11_P3 = [
    (OpUnit.SEQ_SCAN, [80000, 16, 3, 80000]),
...
_Q11_P4 = [
    (OpUnit.SEQ_SCAN, [80000, 20, 4, 80000]),
...
_Q11_P5 = [
    (OpUnit.AGG_ITERATE, [6000, 12, 2, 6000]),
    (OpUnit.OP_DECIMAL_MULTIPLY, [6000, 4, 1, 6000]),
...
_Q11_P6 = [
    (OpUnit.SORT_ITERATE, [5000, 12, 2, 5000]),
    (OpUnit.OUTPUT, [5000, 12, 2, 0]),
]


_SCAN_LINEITEM_P1 = [
    (OpUnit.SEQ_SCAN, [600000, 64, 10, 600000]),
    (OpUnit.OUTPUT, [600000, 64, 10, 0]),
]

_SCAN_ORDERS_P1 = [
    (OpUnit.SEQ_SCAN, [150000, 4, 1, 150000]),
