...
_Q1_P1 = [
    (OpUnit.SEQ_SCAN, [6000000, 48, 7, 6000000]),
...
_Q1_P2 = [(OpUnit.AGG_ITERATE, [4, 92, 10, 4]), (OpUnit.SORT_BUILD, [4, 32, 2, 4])]

_Q1_P3 = [
    (OpUnit.SORT_ITERATE, [4, 92, 10, 4]),
    (OpUnit.OUTPUT, [4, 92, 10, 0]),
]

_Q4_P1 = [
    (OpUnit.SEQ_SCAN, [1500000, 24, 3, 1500000]),
    (OpUnit.OP_DECIMAL_COMPARE, [3000000, 4, 1, 3000000]),
    (OpUnit.HASHJOIN_BUILD, [53570, 4, 1, 53570]),
]

_Q4_P2 = [
    (OpUnit.SEQ_SCAN, [6000000, 12, 3, 6000000]),
    (OpUnit.OP_INTEGER_COMPARE, [6000000, 4, 1, 6000000]),
...
_Q4_P3 = [(OpUnit.AGG_ITERATE, [5, 20, 2, 5]), (OpUnit.SORT_BUILD, [5, 16, 1, 5])]

_Q4_P4 = [(OpUnit.SORT_ITERATE, [5, 20, 2, 5]), (OpUnit.OUTPUT, [5, 20, 2, 0])]

_Q5_P1 = [
    (OpUnit.SEQ_SCAN, [5, 16, 2, 5]),
    (OpUnit.OP_INTEGER_COMPARE, [5, 4, 1, 5]),
    (OpUnit.HASHJOIN_BUILD, [1, 4, 1, 1]),
]

_Q5_P2 = [
    (OpUnit.SEQ_SCAN, [25, 24, 3, 25]),
    (OpUnit.HASHJOIN_PROBE, [25, 4, 1, 5]),
    (OpUnit.HASHJOIN_BUILD, [5, 4, 1, 5]),
]

_Q5_P3 = [
    (OpUnit.SEQ_SCAN, [150000, 8, 2, 150000]),
    (OpUnit.HASHJOIN_PROBE, [150000, 4, 1, 350000]),
    (OpUnit.HASHJOIN_BUILD, [350000, 4, 1, 350000]),
]

_Q5_P4 = [
    (OpUnit.SEQ_SCAN, [1500000, 12, 3, 1500000]),
...
_Q5_P5 = [
    (OpUnit.SEQ_SCAN, [10000, 8, 2, 10000]),
    (OpUnit.HASHJOIN_BUILD, [10000, 8, 2, 10000]),
]

_Q5_P6 = [
    (OpUnit.SEQ_SCAN, [6000000, 24, 4, 6000000]),
...
_Q5_P7 = [(OpUnit.AGG_ITERATE, [5, 20, 2, 5]), (OpUnit.SORT_BUILD, [5, 8, 1, 5])]

_Q5_P8 = [(OpUnit.SORT_ITERATE, [5, 20, 2, 5]), (OpUnit.OUTPUT, [5, 20, 2, 0])]
...
_Q7_P3 = [
    (OpUnit.SEQ_SCAN, [1500000, 8, 2, 1500000]),
...
_Q7_P5 = [
    (OpUnit.SEQ_SCAN, [6000000, 28, 5, 6000000]),
    (OpUnit.OP_INTEGER_COMPARE, [12000000, 4, 1, 12000000]),
...
_Q7_P6 = [
    (OpUnit.AGG_ITERATE, [4, 44, 4, 4]),
    (OpUnit.SORT_BUILD, [4, 36, 3, 4]),
]

_Q7_P7 = [
    (OpUnit.SORT_ITERATE, [4, 44, 4, 4]),
...
_Q11_P3 = [
    (OpUnit.SEQ_SCAN, [800000, 16, 3, 800000]),
...
_Q11_P4 = [
    (OpUnit.SEQ_SCAN, [800000, 20, 4, 800000]),
...
_Q11_P5 = [
    (OpUnit.AGG_ITERATE, [30000, 12, 2, 30000]),
    (OpUnit.OP_DECIMAL_MULTIPLY, [30000, 4, 1, 30000]),
...
_Q11_P6 = [
    (OpUnit.SORT_ITERATE, [2000, 12, 2, 2000]),
    (OpUnit.OUTPUT, [2000, 12, 2, 0]),
]


_SCAN_LINEITEM_P1 = [
    (OpUnit.SEQ_SCAN, [6000000, 64, 10, 6000000]),
    (OpUnit.OUTPUT, [6000000, 64, 10, 0]),
]

_SCAN_ORDERS_P1 = [
    (OpUnit.SEQ_SCAN, [1500000, 4, 1, 1500000]),
