...
_Q1_P1 = [
    (OpUnit.SEQ_SCAN, [60000000, 48, 7, 60000000]),
...
_Q5_P4 = [
    (OpUnit.SEQ_SCAN, [15000000, 12, 3, 15000000]),
...
_Q5_P5 = [
    (OpUnit.SEQ_SCAN, [100000, 8, 2, 100000]),
    (OpUnit.HASHJOIN_BUILD, [100000, 8, 2, 100000]),
]

_Q5_P6 = [
    (OpUnit.SEQ_SCAN, [60000000, 24, 4, 60000000]),
...
_Q5_P7 = [
    (OpUnit.AGG_ITERATE, [5, 20, 2, 5]),
    (OpUnit.SORT_BUILD, [5, 8, 1, 5]),
]

_Q5_P8 = [
    (OpUnit.SORT_ITERATE, [5, 20, 2, 5]),
...
_Q7_P3 = [
    (OpUnit.SEQ_SCAN, [15000000, 8, 2, 15000000]),
...
_Q7_P5 = [
    (OpUnit.SEQ_SCAN, [60000000, 28, 5, 60000000]),
    (OpUnit.OP_INTEGER_COMPARE, [120000000, 4, 1, 120000000]),
...
_Q11_P3 = [
    (OpUnit.SEQ_SCAN, [8000000, 16, 3, 8000000]),
...
_Q11_P4 = [
    (OpUnit.SEQ_SCAN, [8000000, 20, 4, 8000000]),
...
_Q11_P5 = [
    (OpUnit.AGG_ITERATE, [300000, 12, 2, 300000]),
    (OpUnit.OP_DECIMAL_MULTIPLY, [300000, 4, 1, 300000]),
...
_Q11_P6 = [
    (OpUnit.SORT_ITERATE, [20000, 12, 2, 20000]),
    (OpUnit.OUTPUT, [20000, 12, 2, 0]),
]


_SCAN_LINEITEM_P1 = [
    (OpUnit.SEQ_SCAN, [60000000, 64, 10, 60000000]),
    (OpUnit.OUTPUT, [60000000, 64, 10, 0]),
]

_SCAN_ORDERS_P1 = [
    (OpUnit.SEQ_SCAN, [15000000, 4, 1, 15000000]),
